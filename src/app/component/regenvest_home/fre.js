...
//       {/* Background accents */}
//       <div className="pointer-events-none absolute -top-20 -left-32 w-80 h-80 rounded-full bg-purple-500/20 blur-3xl" />
//       <div className="pointer-events-none absolute -bottom-20 -right-32 w-96 h-96 rounded-full bg-indigo-500/20 blur-3xl" />

//       <div className="container mx-auto px-6 relative z-10">
//         <h1 className="text-3xl md:text-6xl font-extrabold bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">
//           Frequently Asked Questions
//         </h1>
